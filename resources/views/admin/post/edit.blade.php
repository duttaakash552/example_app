                    ...
                    <div class="col-lg-8 mx-auto">
						<div class="card">
							...
							<div class="card-body p-4">
								<form id="jQueryValidationForm" method="post" action="<?= route('admin.post.update', $post->id); ?>" enctype="multipart/form-data">
									@csrf
									<div class="row mb-3">
									...
									<div class="row mb-3">
										<label for="input65" class="col-sm-3 col-form-label">Slug</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" id="input65" name="slug" placeholder="Enter Slug" value="<?= $post->slug ?>" required>
										</div>
									</div>
									<div class="row mb-3">
