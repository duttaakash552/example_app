                    ...
                    <div class="col-lg-8 mx-auto">
						<div class="card">
							...
							<div class="card-body p-4">
								<form id="jQueryValidationForm" method="post" action="<?= route('admin.page.insert'); ?>" enctype="multipart/form-data">
									@csrf
									<div class="row mb-3">
										<label for="input35" class="col-sm-3 col-form-label">Title</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" id="input35" name="title" placeholder="Enter Page Title" required>
										</div>
									</div>
									<div class="row mb-3">
									...
									<div class="row mb-3">
										...
										<div class="col-sm-9">
											<input type="checkbox" id="input51" name="ckeck_menu" value="1"/>
										</div>
									</div>
									<div class="row mb-3">
