...
<div class="page-wrapper">
	<div class="page-content">
		...
		<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
			...
			<div class="ms-auto">
				<div class="btn-group">
					<a class="btn btn-primary" href="<?= route('admin.template.create') ?>">Add</a>
				</div>
			</div>
		</div>
		<!--end breadcrumb-->
					...
					<table id="example2" class="table table-striped table-bordered">
						...
						<?php $i++; ?>
							<tr>
								...
								<td><?= $template->name ?></td>
								<td>
									<a href="<?= route('admin.template.edit', $template->id) ?>" class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
								</td>
							</tr>
						<?php } ?>
						</tbody>
