                    ...
                    <div class="col-lg-8 mx-auto">
						<div class="card">
							...
							<div class="card-body p-4">
								<form id="jQueryValidationForm" method="post" action="<?= route('admin.template.update', $template->id); ?>" enctype="multipart/form-data">
									@csrf
									<div class="row mb-3">
										<label for="input35" class="col-sm-3 col-form-label">Template Name</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" id="input35" name="name" placeholder="Enter Template Name" value="<?= $template->name ?>" required>
										</div>
									</div>
									<div class="row mb-3">
										<label for="editor" class="col-sm-3 col-form-label">Header</label>
										<div class="border rounded-4 p-4 mb-4">
											<textarea id="editor" name="template_header"><?= $template->template_header ?></textarea>
										</div>
									</div>
									<div class="row mb-3">
										<label for="editor" class="col-sm-3 col-form-label">Footer</label>
										<div class="border rounded-4 p-4 mb-4">
											<textarea id="editor" name="template_footer"><?= $template->template_footer ?></textarea>
										</div>
									</div>
									<div class="row">
