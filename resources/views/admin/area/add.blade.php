                    ...
                    <div class="col-lg-8 mx-auto">
						<div class="card">
							...
							<div class="card-body p-4">
								<form id="jQueryValidationForm" method="post" action="<?= route('admin.area.insert'); ?>" enctype="multipart/form-data">
									@csrf
									...
									<div class="row mb-3">
										...
										<div class="col-sm-9">
											<input id="datepicker" class="input-group form-control date" type="text" name="published_date" data-date-format="mm-dd-yyyy" />
